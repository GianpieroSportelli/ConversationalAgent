...
public class TranslateToken {
    ...
    private static Logger log = Logger.getLogger(TranslateToken.class.getName());
     ...
     *
     * @param read
     * @param threshold valore di soglia di confidenza
     */
     ...
     * semantica
     *
     * @param name Nome della categoria semantica es. INTENT
     * @param threshold valore di soglia sulla confidenza della particolare
     * categoria semantica
     ...
     * SemanticPool
     *
     * @param pool_name Nome categoria semantica (es. INTENT)
     * @param element_name Nome elemento semantico (es. Creare)
     * @return esito creazione
     */
     ...
     * @param pool_name nome categoria semantica (Es. INTENT)
     * @param element_name nome elemento semantico (Es. Creare)
     * @param example frase d'esempio (Es. vorrei creare)
     * @return esito creazione
     */
            ...
            do {
                ...
                if (element != null) {
                    ...
                    for (int i = 0; i < pool_result.length(); i++) {
                        // Costruisco JSON elemento identificato usando il
                        // risultato
                        // del allineamento
                        ...
                        Token token = new Token(sem_element.getInt("index"), sem_element.getInt("end"), jsonResult,
                                sem_element.getDouble("score"));
     ...
     * fornita da OpeNER
     *
     * @param input frase originale
     * @param partial elementi individuati
     * @return
     */
    /*
     ...
     *
     * @param input dopo la sostituzione delgi elementi semantici individuati
     ...
     * classificati
     *
     * @param input dopo l'individuazione dei numeri e degli elementi semantici
     ...
     *
     * @param input
     * @param pattern identificato nel testo in forma di char array
     * @param text parzialmente elaborato in forma di char array
     * @return
     */
